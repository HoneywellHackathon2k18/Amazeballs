...
<title>
<h2> Fresho Capsicum Hybrid Green
</title>
<style >
.wrapper {
    text-align: center;
...
<!--<div>
  ...
  <img  src="capsicum.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Fresho Capsicum Hybrid Green</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs- 35.00/piece</span> </span>
      <h4>Features</h4>
      <ul>
        <li>1 kg - Rs. 70</li>
        <li>250 gm - Rs. 12</li>
        <li>250 gm - Rs. 12</li>
        <li>Fresho hybrid green capsicums are perfect for adding a dash of colour, distinct taste and beautiful scent to your salad, pizza, pasta or even gravy preparations.</li>
        <li>apples are bright red, thin skinned, white fleshed fruits with a mild sweet flavour and are native to New Zealand. </li>
      </ul>
    </div>
    <br/>
    <br/>
