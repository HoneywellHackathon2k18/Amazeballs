...
<!--<div>
  ...
  <img  src="longdress.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Women's Gown</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; 478 Rs/Kg.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Length: Maxi/Full Length</li>
        <li>Fabric: Silk</li>
        <li>Occasion: Party</li>
        <li>Sleeveless Solid Dress</li>
        <li>Bust (S)36-38 inches (M)38-40 inches (L)40-42 inches (XL)42-44 (XXL)44-46 inches </li>
      </ul>
    </div>
    <br/>
    <br/>
