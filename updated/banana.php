...
<!--<div>
  ...
  <img  src="banana.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Banana </h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-76.38/kg </span> </span>
      <h4>Features</h4>
      <ul>
        <li>1 kg - Rs. 76.38</li>
        <li>500 gm - Rs. 38.19</li>
        ...
        <li> small size, they are naturally flavoured, aromatic and sweeter compared to regular bananas </li>
        <li>Yelakki bananas are around 3- 4 inches long</li>
      </ul>
    </div>
    <br/>
    <br/>
