...
$sqlw="SELECT * FROM view where product='dell'";
...
$sql ="insert into view values('dell',1,'electronics')";
...
<!--<div>
  ...
  <div class="outer">
  <div class="left" ><form action="/action_page.php" method="get" name="dell">
  <img  src="dell.jpg" width="300px" height ="400px" />
</div>
  <div class="right">
    <h3>Dell</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; 80,000.00 </span> </span>
      <h4>Features</h4>
      <ul>
        <li>Intel i5-8250U processor  </li>
        <li>8GB DDR4 RAM  </li>
        <li>1TB hard drive </li>
        <li>15.6-inch screen, AMD Radeon 520 Graphics 2GB Graphics  </li>
    ...
    <div class="comp">
      ...
      <form action="test.php" method= "get" name="dell">
