...
<!--<div>
  ...
  <img  src="apple.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Apple </h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs- 230.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>4 pcs - Rs. 115</li>
        <li>2x4 pcs ( Multipack ) - Rs. 230</li>
        <li>6 pcs - Rs 172.50 (Out of Stock)</li>
