...
<title>
<h2>Flirt NX Skinny Women's Light Blue Jeans</h2>
</title>
<style >
.wrapper {
    text-align: center;
...
<!--<div>
  ...
  <img  src="flirt.jpg" width="300px" height ="400px" />
</div>
  <div class="right">
    <h3>Flirt NX Skinny Women's Light Blue Jeans</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-990.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Fit: Skinny</li>
        <li>Fabric: Denim Lycra</li>
        <li>Clean Look</li>
        <li>Set of 1</li>
      </ul>
    </div>
