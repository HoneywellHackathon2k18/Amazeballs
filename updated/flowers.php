...
<!--<div>
  ...
  <img  src="flowers.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs- 60.00/piece</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Length: 19 inch</li>
        <li>Type: Orchids</li>
        <li>High quality plastic, unbreakable, washable.</li>
        <li>Vase Included </li>
        <li>
  </li>  Bring this beautiful and elegant looking flowers to your home and add a new style to your home decor.</li>
      </ul>
    </div>
    <br/>
    <br/>
