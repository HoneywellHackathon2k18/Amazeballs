...
<title>
<h2> Men Navy Slim Fit Solid Formal Shirt</h2>
</title>
<style >
.wrapper {
    text-align: center;
...
<!--<div>
  ...
  <img  src="arrow.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Men Slim Fit Solid Formal Shirt</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-1500.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Red and  blue solid formal shirt, has a mandarin collar, button placket, long sleeves, a patch pocket</li>
        <li>Cotton and Machine-wash</li>
        <li>Occasion: Party</li>
        <li>10% Cashback on Airtel Money and Airtel Payment Bank. TCA</li>
      </ul>
    </div>
    <br/>
    <br/>
