...
$sqlw="SELECT * FROM view where product='fastrack'";
...
if ($rowcount)
  {
	  $sql1 ="update view
	          set views=views+1
			  where product='fastrack'";
	$result1=mysqli_query($con,$sql1);
   mysqli_free_result($result1);
  }
else{
$sql ="insert into view values('fastrack',1,'electronics')";
...
<!--<div>
  ...
  <div class="outer">
  <div class="left" ><form action="/action_page.php" method="get" name="fastrack">
  <img  src="fastrack.jpg" width="300px" height ="400px" />
</div>
  <div class="right">
    <h3>fastrack</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; 2,350.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Dial Color: Black, Case Shape: Round, Dial Glass Material: Mineral  </li>
        <li>Band Color: Brown, Band Material: Leather  </li>
        <li>Watch Movement Type: Quartz, Watch Display Type: Analog  </li>
        <li>Case Material: Brass, Case Diameter: 47 x 40 millimeters </li>
        <li>Water Resistance Depth: 50 meters, Buckle Clasp  </li>
        <li>1 Year Manufacturing Warranty and 6 Months Battery Warranty</li>
      </ul>
    </div>
    <br/>
    <br/>
    ...
    <div class="comp">
      ...
      <form action="test.php" method= "get" name="fastrack">
...
<!--<form action="test.php" method= "get" name="kindle">
