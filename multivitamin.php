...
$sqlw="SELECT * FROM view where product='multivitamin'";
...
if ($rowcount)
  {
	  $sql1 ="update view
	          set views=views+1
			  where product='multivitamin'";
	$result1=mysqli_query($con,$sql1);
   mysqli_free_result($result1);
  }
else{
$sql ="insert into view values('multivitamin',1,'healthcare')";
...
<!--<div>
  ...
  <div class="outer">
  <div class="left" ><form action="/action_page.php" method="get" name="multivitamin">
  <img  src="multivitamin.jpg" width="300px" height ="400px" />
</div>
  <div class="right">
    <h3>Multivitamin</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; 549.00 </span> </span>
      <h4>Features</h4>
      <ul>
        <li>Multivitamin with the goodness of ginseng extract, taurine and multimineral </li>
        <li>Healthkart multivitamin may help in improving focus and alertness </li>
        <li>Take 1 tablet daily and this may help in improving the immunity and overall health</li>
        <li>1Fortified with 9 essential amino acids </li>
    ...
    <div class="comp">
      ...
      <form action="test.php" method= "get" name="multivitamin">
