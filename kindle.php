...
$sqlw="SELECT * FROM view where product='kindle'";
...
$sql ="insert into view values('kindle',1,'electronics')";
...
<!--<div>
  ...
  <div class="outer">
  <div class="left" ><form action="/action_page.php" method="get" name="kindle">
  <img  src="kindle.jpg" width="300px" height ="400px" />
</div>
  <div class="right">
    <h3>Kindle</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; 10,999.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>High-resolution display with 300 ppi - reads like real paper. Unlike tablets, no screen glare, even in bright sunlight </li>
        <li>Built-in adjustable light - read day and night </li>
        <li>A single battery charge lasts weeks, not hours </li>
        <li>Holds thousands of books. Choose from new releases and bestsellers, including the largest digital selection of bestsellers in Hindi, Tamil, Marathi, Gujarati, and Malayalam.</li>
