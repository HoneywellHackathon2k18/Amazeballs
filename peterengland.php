...
<title>
<h2>
Peter England Men's Checkered Casual Spread Shirt</h2>
</title>
<style >
.wrapper {
    text-align: center;
...
<!--<div>
  ...
  <img  src="peterengland.jpg" width="300px" height ="400px" />
</div>
  <div class="right">
    <h3>Peter England Men's Checkered Casual Spread Shirt</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-1129.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Fabric: Cotton</li>
        <li>Slim Fit, Full Sleeve</li>
        <li>Collar Type: Spread</li>
