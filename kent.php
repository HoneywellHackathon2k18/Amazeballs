...
<!--<div>
  ...
  <img  src="kent.jpg" width="300px" height ="400px" />
</div>
  <div class="right">
    <h3>Kent ACE (11032) 7 L RO</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-31000</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Type: Electrical & Storage</li>
        <li>Purifying Technology: RO + UV +UF</li>
        <li>Total Capacity: 7 LWatch Mo</li>
        <li>Tank Material: ABS Food Grade Plastic</li>
      </ul>
    </div>
    <br/>
    <br/>
