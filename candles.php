...
<title>
<h2>Youth-Combination Analog-Digital Gold Dial Men's Watch </h2>
</title>
<style >
.wrapper {
    text-align: center;
...
<!--<div>
  ...
  <img  src="fastrack.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Youth-Combination Analog-Digital Gold Dial Men's Watch </h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-1900</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Dial Color: Gold, Case Shape: Round</li>
        <li>Band Color: Black, Band Material: Resin</li>
        <li>Watch Movement Type: Quartz, Watch Display Type: Analog-Digital</li>
        <li>Case Material: Resin, Case Diameter: 52.2 millimeters </li>
        <li>Water Resistance Depth: 100 meters</li>
      </ul>
    </div>
    <br/>
    <br/>
