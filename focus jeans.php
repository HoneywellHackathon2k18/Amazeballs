...
<title>
<h2>Focus Slim Women's Dark Blue Jeans</h2>
</title>
<style >
.wrapper {
    text-align: center;
...
<!--<div>
  ...
  <img  src="focus.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Focus Slim Women's Dark Blue Jeans</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-1199.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Fit: Pencil Fit</li>
        <li>Fabric: Silky Stretchable Denim</li>
        <li>Mid Rise Jeans</li>
        <li>Clean Look</li>
        <li>Set of 1</li>
      </ul>
    </div>
