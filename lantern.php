...
<!--<div>
  ...
  <img  src="lantern.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Chinese Multicolor Paper Sky Lantern </h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs- 200.00</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Pack of: 5</li>
        <li>Light Source: Tea Light</li>
        <li>Material: Paper</li>
        <li>Color: Multicolor</li>
        <li>
Sky Lanterns are also known as Wish Lanterns, Night Kites. It is considered good luck to release a sky lantern, and many believe they are symbolic of problems and worries floating away. We provide multiple selections of styles, colors and quantities to ensure you can find the perfect fit your event.  </li>
      </ul>
    </div>
    <br/>
    <br/>
