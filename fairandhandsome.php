...
<title>
<h2> Fair and Handsome Fairness Cream
</title>
<style >
.wrapper {
    text-align: center;
...
<!--<div>
  ...
  <img  src="fairandhandsome.jpg" width="400px" height ="500px" />
</div>
  <div class="right">
    <h3>Fair and Handsome Fairness Cream</h3>
...
<span class="fa fa-star"></span>
    ...
    <div class="des">
      ...
      <h4>Features</h4>
      <ul>
        <li>Day Usage Cream For Fairness, Skin Whitening</li>
        <li>For Men</li>
        <li>Organic Type: Synthetic</li>
        <li>Ideal Usage-Day</li>
        <li>Ideal For-Men </li>
      </ul>
    </div>
    <br/>
