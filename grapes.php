...
<title>
 Fresho Grapes - Green Seedless, Premium, 500 gm
</title>
<style >
.wrapper {
    text-align: center;
...
<!--<div>
  ...
  <img  src="grapes.jpg" width="400px" height ="400px" />
</div>
  <div class="right">
    <h3>Fresho Grapes - Green Seedless, Premium, 500 gm</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-63</span> </span>
      <h4>Features</h4>
      <ul>
        <li>600 gms</li>
        <li>Juicy and snappy, with a beautiful balance of sweet and tart flavour, these grape bunches have a lingering taste</li>
        <li>Green seedless grapes are rich in antioxidant properties and fibres.</li>
        <li>They reduce inflammations and help in weight loss. They also promote heart health and strengthen immunity.</li>
