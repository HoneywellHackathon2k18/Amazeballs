...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-red" style="font-weight:bold">
    <a href="daily_and_heathcare.php" class="w3-bar-item w3-button">Daily and Health care </a>
    <a href="festival.php" class="w3-bar-item w3-button">Festival</a>
  ...
  <header class="w3-container w3-xlarge">
    ...
    <div class="w3-dropdown-hover">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="#" class="w3-bar-item w3-button">Featured Products</a>
        <a href="#" class="w3-bar-item w3-button">Network Components Products</a>
        <a href="#" class="w3-bar-item w3-button">Exclusive Products</a>
      </div>
  ...
  <div class="w3-row w3-grayscale">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <p>Festival Products<br><b>250 Rs</b></p>
      </div>
    </div>
