...
<!--<div>
  ...
  <img  src="ferrerorocher.jpg" width="400px" height ="500px" />
</div>
  <div class="right">
    <h3>Ferrero Rocher 24 Pcs Chocolate Truffles (300 g)</h3>
...
<span class="fa fa-star"></span>
    ...
    <hr/>
    <div class="des">
      <span><b> MRP:</b> <span style="color:red">  &#x20b9; Rs-189</span> </span>
      <h4>Features</h4>
      <ul>
        <li>Milk chocolate</li>
        <li>Dark Chocolate Flavor</li>
        <li>Gourmet</li>
        <li>Ferrero Rocher can be the perfect treat for that special person in your life and it will surely make her smile.</li>
        <li>This box contains 24 pieces of chocolate truffles </li>
      </ul>
    </div>
    <br/>
    <br/>
